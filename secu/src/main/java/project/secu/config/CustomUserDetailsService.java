...
import project.demo.domain.Member.MemberAuthMap;
import project.demo.domain.Member.MemberService;
...
public class CustomUserDetailsService implements UserDetailsService {
     ...
     * @return
     */
    private Collection<? extends GrantedAuthority> getAuthorities(Member memberInfo) {
    ...
    public String[] convert(List<MemberAuthMap> list)
    {
        ...
        for (MemberAuthMap memberAuthMap : list) {
            arrayOfString[index++] = memberAuthMap.getMemberAuthSeq().getAuthority();
        }
